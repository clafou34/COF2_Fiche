...
function gestionChargeListe() {
    ...
    for (let varFichier of varTabFichiers) {
        ...
        lien1.addEventListener('click', function(e){gestionBtnOpenOnClick(varFichier.identifiant); e.stopPropagation();});
        div1 = document.createElement("div");
        div1.innerText = "Modif : " + varFichier.dateModif;
        cell1.addEventListener('click', function(e){gestionBtnOpenOnClick(varFichier.identifiant); e.stopPropagation();});
        ...
        btnSuppr.addEventListener('click', function(e){gestionBtnDeleteOnClick(varFichier.identifiant); e.stopPropagation();});
        cell2.addEventListener('click', function(e){gestionBtnDeleteOnClick(varFichier.identifiant); e.stopPropagation();});
